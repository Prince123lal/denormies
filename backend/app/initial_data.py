...
manage_data = [
    {
        ...
        "event_id": "1",
        "position": "Head",
        "responsibility": "Overlooks the event",
    },
    {
        "id": "U002",
        "event_id": "1",
        "position": "Secretary",
        "responsibility": "Assists the guest lecturer in the event",
    },
    {
        "id": "U004",
        "event_id": "1",
    ...
    },
    {
        ...
        "event_id": "2",
        "position": "Head",
        "responsibility": "Overlooks the event. Question Framing",
    },
    {
        "id": "U007",
        "event_id": "2",
        "position": "Secretary",
        "responsibility": "Invigilation and crowd management",
    },
    {
        "id": "U006",
        "event_id": "3",
    ...
    },
    {
        ...
        "event_id": "4",
        "position": "Head",
        "responsibility": "Overlooks the event. Game Design",
    },
    {
        "id": "U007",
        "event_id": "4",
    ...
    },
    {
        ...
        "event_id": "5",
        "position": "Head",
        "responsibility": "Overlooks the event. Relations management",
    },
    {
        "id": "U002",
        "event_id": "5",
        "position": "Secretary",
        "responsibility": "Assistance for the guest",
    },
    {
        "id": "U004",
        "event_id": "5",
    ...
    async with session.begin():
        ...
        for participant in participant_data:
            ...
            participant["accomodation_id"] = (
                convert_to_uuid(participant["accomodation_id"])
                if participant["accomodation_id"]
                else None
            )
            participant["mess_id"] = (
                convert_to_uuid(participant["mess_id"])
        ...
        for reg in registration_insert:
            reg["event_id"] = convert_to_uuid(reg["event_id"])
            reg["user_id"] = convert_to_uuid(reg["user_id"])
            await session.execute(insert(Registration).values(reg))
